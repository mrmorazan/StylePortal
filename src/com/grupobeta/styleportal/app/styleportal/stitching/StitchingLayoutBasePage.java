...
public class StitchingLayoutBasePage extends WebPage {
	...
	protected StitchingLayoutBasePage(StitchingRadialMenuPanel radialMenu, StitchingMenuPanel bomMenuPanel) {
		this(radialMenu, bomMenuPanel, new HeaderPanel(true), new MenuMain());
	}

	protected StitchingLayoutBasePage(final StitchingRadialMenuPanel radialMenu, final StitchingMenuPanel menu, final HeaderPanel header, final MenuMain menuMain) {
