...
public class BOMMenuPanel extends MenuPanel {
	...
	public BOMMenuPanel(StylePolyPm style, String opcionName) {
		...
		back.add(!style.getUrlStyleImage().equals("0")
				? new RemoteImage("remoteImage", Model.of(style.getUrlStyleImage()), pathFinal)
				: new ContextImage("remoteImage", "img/notAvailableImage.png"));
