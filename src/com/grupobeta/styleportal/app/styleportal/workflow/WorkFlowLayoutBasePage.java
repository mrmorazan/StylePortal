...
public class WorkFlowLayoutBasePage extends WebPage {
	...
	protected WorkFlowLayoutBasePage(WorkFlowRadialMenuPanel radialMenu, WorkFlowMenuPanel bomMenuPanel) {
		this(radialMenu, bomMenuPanel, new HeaderPanel(true), new MenuMain());
	}

	protected WorkFlowLayoutBasePage(final WorkFlowRadialMenuPanel radialMenu, final WorkFlowMenuPanel menu, final HeaderPanel header, final MenuMain menuMain) {
