...
public class ArtLayoutBasePage extends WebPage {
	...
	protected ArtLayoutBasePage(ArtRadialMenuPanel radialMenu, ArtMenuPanel bomMenuPanel) {
		this(radialMenu, bomMenuPanel, new HeaderPanel(true), new MenuMain());
	}

	protected ArtLayoutBasePage(final ArtRadialMenuPanel radialMenu, final ArtMenuPanel menu, final HeaderPanel header, final MenuMain menuMain) {
