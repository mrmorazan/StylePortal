...
public class TechPackLayoutBasePage extends WebPage {
	...
	protected TechPackLayoutBasePage(TechPackRadialMenuPanel radialMenu, TechPackMenuPanel bomMenuPanel) {
		this(radialMenu, bomMenuPanel, new HeaderPanel(true), new MenuMain());
	}

	protected TechPackLayoutBasePage(final TechPackRadialMenuPanel radialMenu, final TechPackMenuPanel menu, final HeaderPanel header, final MenuMain menuMain) {
