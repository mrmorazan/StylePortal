...
public class TechPackPage extends TechPackBasePage<InstructionPolyPm> {
	private static final long serialVersionUID = 1L;

	DocumentPolyPm specDocument;

	public TechPackPage(StylePolyPm style) {
		super(style);

		setSpecDocument(getTransService().loadDocumentPolyPmTechPack(style));
