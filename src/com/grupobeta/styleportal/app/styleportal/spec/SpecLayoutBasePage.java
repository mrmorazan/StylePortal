...
public class SpecLayoutBasePage extends WebPage {
	...
	protected SpecLayoutBasePage(SpecRadialMenuPanel radialMenu, SpecMenuPanel bomMenuPanel) {
		this(radialMenu, bomMenuPanel, new HeaderPanel(true), new MenuMain());
	}

	protected SpecLayoutBasePage(final SpecRadialMenuPanel radialMenu, final SpecMenuPanel menu, final HeaderPanel header, final MenuMain menuMain) {
