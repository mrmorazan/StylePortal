...
@AuthorizeInstantiation(Rol.ADMINISTRADOR)
public abstract class AdminBasePage<T extends DomainObject> extends BasePage {
	...
	public AdminBasePage(){
		super(new AdminMenuPanel(), new HeaderPanel(), new MenuMain());
	}
